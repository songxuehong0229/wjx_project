        ...
        <li v-for="(item,index) in items" :key="index">
            ...
            <div class="downImg">
              ...
              <div class="rightImg">
                  ...
                  <p class="rub">
                    <!-- <button  @click="reduce(item)">-</button><input type="text" name="" v-model="item.sale_count"><button @click="item.sale_count++">+</button> -->
...
export default {
    ...
    mounted(){
      ...
      .then(function(res){
        // console.log(214445668,res.data.result.upcoming_list[0])
        this.items = res.data.result.upcoming_list[0].product_list
      })
    },
    updated(){
